        ...
        card.innerHTML = `
            ...
            <div class="card-content">
                <div>
                    ...
                    <span class="regra-ouro">⚠️ ${produto.pedido_minimo}</span>
                    <span class="preco-exemplo">${produto.preco}</span>
                </div>
                <button onclick="navegarParaProduto('${produto.id}')" class="btn-primary">Ver Catálogo Exclusivo</button>
            </div>
        `;
...
function mostrarProduto(id) {
    ...
    paginaDinamica.innerHTML = `
        ...
        <div class="pagina-produto-hero">
            <span class="tag-catalogo">Catálogo Exclusivo</span>
            <h1>${produto.nome}</h1>
        ...
        <div class="pagina-produto-cta">
            <a href="https://wa.me/5599999999999?text=${wppText}" target="_blank" class="btn-primary">
            ...
            <p class="aviso">Você será direcionado ao WhatsApp com a mensagem já preenchida sobre este produto.</p>
        </div>
    `;
    window.scrollTo(0, 0);
}
